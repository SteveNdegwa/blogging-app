...
export const Post = ({ post }: Props) => {
  ...
  const getLikes = async () => {
    ...
    setLikesList(data.docs.map((doc) => ({ userId: doc.data().postId, postId: doc.data().postId, id: doc.id })));
  ...
  const getComments = async () => {
    ...
    setCommentsList(
      data.docs.length ? 
      data.docs.map((doc) => ({ userId: doc.data().userId, username: doc.data().userId, postId: doc.data().userId, comment: doc.data().userId, id: doc.id })) :null
    );
  };
